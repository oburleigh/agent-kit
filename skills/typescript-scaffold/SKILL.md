...
1. Resolve the target, project name, description, author, repository URL, preset, and requested stack. Ask only when an unsafe or material choice cannot be inferred.
2. Select a profile:
